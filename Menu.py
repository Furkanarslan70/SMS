...
r = get("https://raw.githubusercontent.com/Furkanarslan70/SMS/main/sms.py").text
...
r = get("https://raw.githubusercontent.com/Furkanarslan70/SMS/main/call.py").text
...
while 1:
    ...
    if menu == 1:
        ...
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + " Furkan\n King")
        sleep(12)
    elif menu == 4:
        system("cls||clear")
